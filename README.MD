...
Download the latest release from [GitHub Releases](https://github.com/sirixdb/brackit/releases) and run:
...
# Use bjq (jq-like interface)
java -jar bjq-jar-with-dependencies.jar '$$.name' data.json
```
